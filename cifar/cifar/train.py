...
def get_model(config, device=-1, relu_inplace=True):
    ...
    model = {
        'vgg11_nobias': lambda: model.VGG('VGG11', num_classes, batch_norm=False, bias=False, relu_inplace=relu_inplace),
        'vgg11_half_nobias': lambda: model.VGG('VGG11_half', num_classes, batch_norm=False, bias=False,
                                           relu_inplace=relu_inplace),
        'vgg11_doub_nobias': lambda: model.VGG('VGG11_doub', num_classes, batch_norm=False, bias=False,
                                           relu_inplace=relu_inplace),
        'vgg11_quad_nobias': lambda: model.VGG('VGG11_quad', num_classes, batch_norm=False, bias=False,
                                           relu_inplace=relu_inplace),
        'vgg11':     lambda: model.VGG('VGG11', num_classes, batch_norm=False, relu_inplace=relu_inplace),
        'vgg11_bn':  lambda: model.VGG('VGG11', num_classes, batch_norm=True, relu_inplace=relu_inplace),
        'resnet18':  lambda: model.ResNet18(num_classes=num_classes),
        'resnet18_nobias': lambda: model.ResNet18(num_classes=num_classes, linear_bias=False),
        'resnet18_nobias_nobn': lambda: model.ResNet18(num_classes=num_classes, use_batchnorm=False, linear_bias=False),
    }[config['model']]()
